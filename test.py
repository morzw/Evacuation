...
# from Evacuation.code.Agent import *
import random
import timeit

# from Evacuation.code.Environment import *
#
# from Evacuation.code.Environment import Environment
from Evacuation.code.Agent import Agent
from Evacuation.code.Environment import Environment, Goal, Point, ReachedGoal, EnvironmentViewer
